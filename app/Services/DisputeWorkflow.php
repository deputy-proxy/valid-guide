...
class DisputeWorkflow
{
    ...
    public function assignReviewer(Dispute $dispute, User $reviewer, User $assignedBy): DisputeReviewer
    {
        ...
        if (! in_array($dispute->status->value, [DisputeStatus::Submitted->value, DisputeStatus::UnderReview->value], true)) {
    ...
    /** @return array{dispute: Dispute, new_evaluation: Evaluation|null} */
