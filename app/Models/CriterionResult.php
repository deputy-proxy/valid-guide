...
{
    use HasFactory;
    protected $fillable = ['auditor_evaluation_id','criterion_id','assessment','score','rationale','confidence','submitted_at'];
    protected function casts(): array { return ['score'=>'decimal:2','confidence'=>'decimal:2','submitted_at'=>'datetime']; }
